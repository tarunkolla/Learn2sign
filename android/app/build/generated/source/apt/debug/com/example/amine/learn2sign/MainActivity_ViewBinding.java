...
public class MainActivity_ViewBinding implements Unbinder {
  ...
  public MainActivity_ViewBinding(final MainActivity target, View source) {
    ...
    view = Utils.findRequiredView(source, R.id.bt_reject, "field 'bt_reject' and method 'reject'");
    target.bt_reject = Utils.castView(view, R.id.bt_reject, "field 'bt_reject'", Button.class);
    view2131296298 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    view = Utils.findRequiredView(source, R.id.bt_proceed, "field 'bt_proceed' and method 'goToGrade'");
    target.bt_proceed = Utils.castView(view, R.id.bt_proceed, "field 'bt_proceed'", Button.class);
    view2131296295 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
